...
export const ToolRegistry: Record<string, ComponentType<any>> = {
  ...
  'peso': dynamic(() => import('@/app/tools/peso/page')),
  'golden-circle': dynamic(() => import('@/app/tools/golden-circle/page')),
  ...
  'seo-pyramide': dynamic(() => import('@/app/tools/seo-pyramide/page')),
  'strategisk-afvejning': dynamic(() => import('@/app/tools/strategisk-afvejning/page')),
  'aida-funnel': dynamic(() => import('@/app/tools/aida-funnel/page')),
  'dvf-venn-model': dynamic(() => import('@/app/tools/dvf-venn-model/page')),
  'smuk-model': dynamic(() => import('@/app/tools/smuk-model/page')),
  'smp-model': dynamic(() => import('@/app/tools/smp-model/page')),
