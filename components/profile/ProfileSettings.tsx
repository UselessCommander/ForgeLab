...
export default function ProfileSettings({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? '' : 'min-h-screen bg-gray-50'}>
        ...
        <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-gray-200/60">
          <div className="max-w-[1600px] mx-auto px-5 h-14 flex items-center justify-between gap-4">
            <Link href="/dashboard" className="flex items-center gap-2">
              <span className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-amber-500 text-white shadow-sm shadow-amber-500/30">
      ...
      <div className={`max-w-5xl mx-auto px-6 ${embedded ? 'py-8' : 'py-10'}`}>
        {/* Page title */}
        <div className="mb-8">
