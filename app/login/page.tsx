        ...
        <nav className="border-b border-gray-200/80 bg-white/70 backdrop-blur-md sticky top-0 z-50 transition-shadow hover:shadow-sm">
          <div className="container mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              ...
              <Link
                href="/register"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-medium hover:border-amber-300 hover:bg-amber-50/50 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
              >
                Opret Bruger
              </Link>
            </div>
          ...
          <div className="w-full max-w-md animate-scale-in">
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl border border-amber-100/80 shadow-xl shadow-amber-500/10 p-8 md:p-10 animate-glow-pulse">
              <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-gray-900 bg-clip-text">Log ind</h1>
                <p className="text-gray-600 mt-1">Log ind for at fortsætte til dashboard</p>
              </div>
              <LoginFormClient />
            </div>
          </div>
